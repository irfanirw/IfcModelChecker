...
// ===== Section Store (clipping plane panel) =====
...
interface SectionState {
    ...
    setGumballAxis: (axis: GumballAxis) => void;
    setFlipped: (flipped: boolean) => void;
    setCapVisible: (visible: boolean) => void;
    resetSection: () => void;
}
...
export const useSectionStore = create<SectionState>()((set) => ({
    panelOpen: false,
    enabled: false,
    planeAxis: 'Z' as PlaneAxis,
    gumballAxis: 'Z' as GumballAxis,
    flipped: false,
    capVisible: true,
    ...
    setGumballAxis: (gumballAxis) => set({ gumballAxis }),
    setFlipped: (flipped) => set({ flipped }),
    setCapVisible: (capVisible) => set({ capVisible }),
    resetSection: () => set({
        enabled: false,
        planeAxis: 'Z' as PlaneAxis,
        gumballAxis: 'Z' as GumballAxis,
